...
/**
 * @fileOverview A Genkit flow for paraphrasing text.
 *
 * - paraphraseText - A function that paraphrases the given text.
...
const ParaphraseTextOutputSchema = z.object({
  paraphrasedText: z.string().describe('The paraphrased version of the text.'),
});
...
const paraphraseTextPrompt = ai.definePrompt({
  ...
  prompt: `You are an AI that paraphrases text, rephrasing it while maintaining the original meaning. Paraphrase the following text.
